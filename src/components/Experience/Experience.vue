  ...
  <div class="self-center q-pa-lg">
    ...
    <q-timeline layout="comfortable" side="right" color="secondary">
      <q-timeline-entry
        ...
        side="right"
      >
        <div>Pursuing a Master Dregree in Ariticial Intelligence at the University of St. Thomas.</div>
      </q-timeline-entry>
      <q-timeline-entry
      ...
      <q-timeline-entry
        title="University of St. Thomas, Researcher"
